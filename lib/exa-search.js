...
import { formatSearchResultsForModel, SEARCH_MAX_RESULTS } from "./search-provider.js";
...
export class ExaMcpSearchProvider {
  /** @type {string} */
  #url;
  ...
  async search(query, options = {}) {
    ...
    if (Number.isFinite(options.maxTotalChars)) {
      searchArguments.contextMaxCharacters = options.maxTotalChars;
    }
